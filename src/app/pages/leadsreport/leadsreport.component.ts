...
import { StatisticRecord, StatisticTable, StatisticTotal, LastEntries, Person, Action, Lead, LeadsReport } from 'app/app.component';
...
export class LeadsReportComponent implements OnInit{
  ...
  leads:          Lead[]=[];
  actions:        Action[]=[];
  urlSafe = 'http://45.83.43.173:3000/files/lead_report/lead_report.xlsx'
  //'https://rt-crm.com/lead_report/lead_report.xlsx';
  ...
  requestStatistic (intEnd,intStart) {
    ...
    this.ServerApiService.fetchLeadsReport(strData)
